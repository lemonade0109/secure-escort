...
const AvailabilityCard: React.FC<
  AvailabilityCardProps & { name: string; email: string; role: string }
      ...
      <CardContent className="space-y-4">
        {!data ? (
          ...
          <>
            ...
            <p className="text-xs text-white/60">
              Admin assignment will only work if the request time falls inside
              an availability block and you’re not busy.
            </p>
          </>
        )}
      </CardContent>
