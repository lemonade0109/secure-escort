...
export default function GuardJobDetailsLoading() {
  return (
    <main className="min-h-screen relative overflow-hidden bg-[#070a12] text-white">
      ...
      <div className="relative z-10 max-w-5xl px-6 py-8 sm:py-10 mx-auto space-y-6">
        <div className="flex justify-between">
          ...
          <div className="flex items-center gap-2 sm:mt-5 animate-pulse">
            <div className="hidden sm:flex h-6 w-20 rounded-full bg-white/10" />
